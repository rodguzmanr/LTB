...
#######################################################################
    ...
    print('max_mass_pv = '+str(int(max_mass_pv/1000.))+' [ton]')
    print('max_dens_pv = '+str(np.round(max_dens_pv, decimals=3))+' [kg.m^-2]')
    print('max_mass_tower + max_mass_pv = '+str(int(max_mass_tower/1000.))+' + '+str(int(max_mass_pv/1000.))+' [ton] = ')
    print('total_mass_structure = '+str(int(total_mass_structure/1000.))+' [ton]')
    print('mass_h2_tower + mass_h2_pv = '+str(int(mass_h2_tower/1000.))+' + '+str(int(mass_h2_pv/1000.))+' [ton] =')
    print('total_mass_h2 = '+str(int(total_mass_h2/1000.))+' [ton]')
    print('total_mass_h2/total_mass_structure =')
    print('total_mass_ratio = '+str(np.round(total_mass_ratio, decimals=4))+' [no unit]')
    ...
    print('mass_mod_min = '+str(int(mass_mod_min/1000.))+' [ton], d_mod_min = '+str(int(d_mod_min))+' [m], nb_cube_mod = '+str(nb_cube_mod[0]))
    print('Highest module features:')
    print('mass_mod_max = '+str(int(mass_mod_max/1000.))+' [ton], d_mod_max = '+str(int(d_mod_max))+' [m], nb_cube_mod = '+str(nb_cube_mod[-1]))
    print('\n***********\n')    
