...
#######################################################################
    ...
    print('\n***********\n')    
    print('Variables de sortie de la structure simulée:')
    print('max_mass_pv = '+str(int(max_mass_pv/1000.))+' [tonnes]')
    print('max_dens_pv = '+str(np.round(max_dens_pv, decimals=3))+' [kg.m^-2]')
    print('max_mass_tower + max_mass_pv = '+str(int(max_mass_tower/1000.))+' + '+str(int(max_mass_pv/1000.))+' [tonnes] = ')
    print('total_mass_structure = '+str(int(total_mass_structure/1000.))+' [tonnes]')
    print('mass_h2_tower + mass_h2_pv = '+str(int(mass_h2_tower/1000.))+' + '+str(int(mass_h2_pv/1000.))+' [tonnes] =')
    print('total_mass_h2 = '+str(int(total_mass_h2/1000.))+' [tonnes]')
    print('total_mass_h2/total_mass_structure =')
    print('total_mass_ratio = '+str(np.round(total_mass_ratio, decimals=4))+" [pas d'unité]")
    print(str(np.round(total_mass_ratio*100., decimals=2))+" % de la masse de la structure est de l'H2")
    ...
    print('Caractéristiques du module le plus bas:')
    print('mass_mod_min = '+str(int(mass_mod_min/1000.))+' [tonnes], d_mod_min = '+str(int(d_mod_min))+' [m], nb_cube_mod = '+str(nb_cube_mod[0]))
    print('Caractéristiques du module le plus haut:')
    print('mass_mod_max = '+str(int(mass_mod_max/1000.))+' [tonnes], d_mod_max = '+str(int(d_mod_max))+' [m], nb_cube_mod = '+str(nb_cube_mod[-1]))
    print('\n***********\n')    
    print('Variables de sortie de la production énergétique:')
    print('max_power = '+str(max_power/1e6)+' [MW]')
    print('day_energy_prod = '+str(day_energy_prod/1e9)+' [GWh/jour]')
    print('year_energy_prod = '+str(year_energy_prod/1e12)+' [TWh/an]\n')   
